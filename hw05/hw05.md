...
We are going to explore the gapminder data set, uncluding:
...
**b.** Reorder the countries based on life expectancy, and see if the reorder has effect on plots.
...
**c.** First reorder the countries based on minimum of life expectancy, then arranged the data based on life expectancy, and see if the reorder and arrange has effect on plots.
