...
Arrange the data based on life expectancy.
...
Reorder the countries based on minimum of life expectancy.
...
First reorder the countries based on minimum of life expectancy, then arranged the data based on life expectancy.
...
![](hw05_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-12-2.png) I facetted the density plots wrt continents, I changed the color of the plots by changing the color scheme to "Dark2", I also added a title to my plot, and I changed the theme of the plot.
