...
-   Create a nested data frame and map a linear regression function and a robust regression function over the list column holding the nested data, and get information out of the linear models to make some exploration of the data.
