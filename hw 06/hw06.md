...
-   **Work with a nested data frame** Create a nested data frame and map a linear regression function and a robust regression function over the list column holding the nested data, and make some exploration to get information out of the linear models.
