...
-   Output:
    ...
    -   `le_lin_fit`: a list of estimated intercept, slope, and the estimated mean square prediction error (mspe), from a linear regression of lifeExp on year

    -   `le_r_fit`: a list of estimated intercept, slope, and the estimated mean square prediction error (mspe), from a robust regression of lifeExp on year
...
From the plot, we notice that there are two outliers of lifeExp in year 1952 and 1962.
...
**(8)** Numerical and graphical summarization of the estimated intercept and slope.
