...
-   Output:
    ...
    -   `le_r_fit`: a list of estimated intercept, slope, and the estimated estimated mean square prediction error (mspe), from a robust regression of lifeExp on year
