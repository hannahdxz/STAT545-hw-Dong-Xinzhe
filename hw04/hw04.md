...
Make a tibble with one row per year and columns for life expectancy for Canada and Gambia.
...
Make the data "tidy" by gathering LifeExp\_Canada, and LifeExp\_Gambia.
...
Again, use kable() to render the tidy table.
