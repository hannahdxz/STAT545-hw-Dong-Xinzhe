...
We are going to explore the gapminder data set included with R. We will be practicing data reshaping and join.

#### Table of content

-   [1 Installation of packages](#installation_of_packages)
-   [2 General data reshaping and relationship to aggregation](#general_data_reshaping_and_relationship_to_aggregation)
-   [3 Join, merge, look up](#join,_merge,_look%20up)
...
```
    ...
    ##     year        LifeExp Years
    ##    <int>          <chr> <dbl>
    ##  1  1952 LifeExp_Canada 68.75
    ##  2  1957 LifeExp_Canada 69.96
    ##  3  1962 LifeExp_Canada 71.30
    ##  4  1967 LifeExp_Canada 72.13
    ##  5  1972 LifeExp_Canada 72.88
    ##  6  1977 LifeExp_Canada 74.21
    ##  7  1982 LifeExp_Canada 75.76
    ##  8  1987 LifeExp_Canada 76.86
    ##  9  1992 LifeExp_Canada 77.95
    ## 10  1997 LifeExp_Canada 78.61
    ## # ... with 14 more rows
...
-   Taking advantege of this new data shape, we are able to scatterplot life expectancy for one country against that of another.
