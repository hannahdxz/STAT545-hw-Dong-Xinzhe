...
-   [1 Installation of packages](#installation-of-packages)
-   [2 General data reshaping and relationship to aggregation](#general-data-reshaping-and-relationship-to-aggregation)
-   [3 Join, merge, look up](#join-merge-look-up)
